...
CONFIG_FILES="backend/data.db backend/data.duckdb backend/data_staging.duckdb backend/data_staging.duckdb.wal backend/.app_config backup.sh configure_cors.sh update.sh install.sh scripts/install/install.sh"
